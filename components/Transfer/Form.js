  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit}>
        <div>
          <Field name="recipientTransfer" component={TextField} hintText="Ingrese Destinatario" floatingLabelText="Nombre y Apellidos" ref="recipientTransfer" withRef/>
        </div>
        <div>
